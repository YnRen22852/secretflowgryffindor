...
class MainWindow(QMainWindow):
    ...
    def create_function1_pages(self):
        ...
        # 连接子功能按钮点击事件
        self.sub_function1_button.clicked.connect(lambda: self.show_output_page("secretflowgryffindor-main/data/full_table_statistics.py", "Full Table Statistics Output"))
        self.sub_function2_button.clicked.connect(lambda: self.show_output_page("secretflowgryffindor-main/data/multicollinearity_test.py", "VIF Multicollinearity Test Output"))
        self.sub_function3_button.clicked.connect(lambda: self.show_output_page("secretflowgryffindor-main/data/corr_coefficient_matrix.py", "Correlation Coefficient Matrix Output"))
